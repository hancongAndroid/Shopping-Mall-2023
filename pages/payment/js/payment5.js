...
// 自动拉起会员卡
// let WXCardType = localStorage.getItem('handleToWXCard') || ''
// if (WXCardType != 1) {
//     let isWX = WeiXinType()
//     if (isWX) handleToWXCard(window.location.href)
// }
// localStorage.setItem('handleToWXCard','1')
...
$('.bottom-btn, .bottom-content,.wrapper').on('click', function() {
    switch (wxType) {
        case 1:
            openWeapp2('packageA/pages/webviewH5/webview', 'url=https://svip.quanminyanxuan.com/pages/integralCenter/gold.html')
            break;
        case 2:
