...
$(function () {
    ...
    $('#infoTitle,.oldForNew-product-info-4 .right').on('click', function () {
        window.open(`../productDetail/newsProductDetail.html?productId=${productInfo.id}`, '_self')
    })
    ...
    */
	...
	$(document).on('click', '.viewDetail', function() {
		window.location.href = '../productDetail/newsProductDetail.html?productId=' + productId
	})
