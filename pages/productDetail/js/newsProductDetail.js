...
let productId = getUrlKey('productId') || 10128//10349 //10972 //1677 	//1596
...
let random = Math.floor(Math.random()*20)+1 //随机1-20整数
let productInfo = {}
timer()						// 倒计时
pageStatistics() 			// 页面统计
...
function getProductInfo() {
	http('GET', `/mallv2/product/getProductInfoById`, {
		...
		$('.price-activityMax, #activityMaxPopup').text(productInfo.originalPrice-productInfo.price)
			...
			if (i < 6) {
				recommond1 += `<div class="product-item" onclick="window.open('./newsProductDetail.html?productId=${n.id}', '_self')">
								...
								<div class="product-info">
									...
									<div class="label">补贴${n.activityMax}元</div>
									<!--<div class="price-real">补贴后¥<span class="num">${n.price}</span></div>-->
...
$(function () {
	...
	$('#numberSelectdiv').on('click', function() {
        ...
        // $('.simple-address .priceReal').text(productInfo.price*num)
