...
let productId = getUrlKey('productId') || 31970
...
function getProductInfo () {
    http('GET', `/mallv2/product/getProductInfoById`, {
		...
		$('.couponSum').text(Math.round(productInfo.curPrice - productInfo.price))
        // 评价
...
$(function () {
    ...
    */
	...
	$(document).on('click', '.viewDetail', function() {
		window.location.href = '../productDetail/guessProductDetail2.html?productId=' + productId
	})
