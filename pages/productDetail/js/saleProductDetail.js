...
function getRecommendOther() {
	http('GET', `/mallv2/h5/membersale/queryListByPage`, {
		...
		$.each(recommond, (i, n) => {
			if (i < 3) {
				recommond1 += `<div class="product-item" onclick="window.open('./saleProductDetail.html?productId=${n.id}', '_self')">
				...
				recommond2 += `<div class="product-item" onclick="window.open('./saleProductDetail.html?productId=${n.id}', '_self')">
								<img class="product-image" src="${n.productImg}" />
								<div class="g-product-info">
									<div class="descr">${n.productName}</div>
									<div class="integral-price">
