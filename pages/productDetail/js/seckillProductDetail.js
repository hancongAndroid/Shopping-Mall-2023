...
let productId = getUrlKey('productId') || 13380
let specMap = {}	//查规格信息
...
function getRecommendOther() {
	http('GET', `/mallv2/h5/skill/queryListByPage`, {
		...
		$.each(recommond, (i, n) => {
			if (i < 3) {
				recommond1 += `<div class="product-item" onclick="window.open('./seckillProductDetail.html?productId=${n.id}', '_self')">
				...
				recommond2 += `<div class="product-item" onclick="window.open('./seckillProductDetail.html?productId=${n.id}', '_self')">
								<img class="product-image" src="${n.productImg}" />
								<div class="g-product-info">
									<div class="descr">${n.productName}</div>
									<div class="integral-price">
