...
function getProductInfo () {
    http('GET', `/mallv2/product/getProductInfoById`, {
        ...
        $('#priceYuan,.curPrice').text(productInfo.curPrice)
        ...
        $('#couponPrice').text(`可用券${Math.round(productInfo.curPrice-productInfo.price)}元`)
...
$(function () {
    ...
    // 购买按钮
    $('#shopBtn, #shopBtn1, #shopBtn3').on('click', function () {
