...
function productListShow(productList, element) {
	...
	$.each(productList, (i, n) => {
		...
		if (n.stock == 0) {
			...
			oDiv = `<div class="minbox-news" onclick="window.open('../productDetail/news2ProductDetail.html?productId=${n.id}', '_self')">`
		}
		html += `${oDiv}
					...
					<div class="label">
						<div class="labelImg">
							<image class="labelImg1" src="https://img.quanminyanxuan.com/other/76852a8b100449f6b8d4dc4b31710bf3.png" />
