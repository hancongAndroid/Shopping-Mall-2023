		...
		if (item.stock == 0) {
            ...
            switch (item.activityType) {
                case "OLD_FOR_NEW":
                    ...
                    break;
                case "H5_COUPON":
			        oDiv = `<div class="product-item-guess" onclick="window.open('../productDetail/guessProductDetail2.html?productId=${item.id}', '_self')">`
                    break;
                case "H5_MEMBER_DISCOUNT":
			        oDiv = `<div class="product-item-guess" onclick="window.open('../productDetail/memberDiscountDetail.html?productId=${item.id}', '_self')">`
                    break;
                case "H5_RED_PACKET":
			        oDiv = `<div class="product-item-guess" onclick="window.open('../productDetail/brandSaleProductDetail.html?productId=${item.id}', '_self')">`
                    break;
                case "CASH_SCORE":
			        oDiv = `<div class="product-item-guess" onclick="window.open('../productDetail/productDetail.html?productId=${item.id}', '_self')">`
                    break;
                default:
                    oDiv = `<div class="product-item-guess" onclick="window.open('../productDetail/guessProductDetail.html?productId=${item.id}', '_self')">`
                    break;
